...
private fun SportsListAndDetails(
    sports: List<Sport>,
    onClick: (Sport) -> Unit,
    //sportListContentPadding: PaddingValues = PaddingValues(0.dp),
    selectedSport: Sport,
    onBackPressed: () -> Unit,
    modifier: Modifier = Modifier,
    padding: PaddingValues,
    //sportDetailContentPadding: PaddingValues,
    //sportDetailModifier: Modifier = Modifier
) {
    Row(
        ...
        SportsList(
            sports = sports,
            onClick = onClick,
            modifier = modifier//sportListModifier
                .weight(2f)
                .padding(horizontal = dimensionResource(R.dimen.padding_medium)),
            contentPadding = padding//sportListContentPadding
        )
        SportsDetail(
            selectedSport = selectedSport,
            onBackPressed = onBackPressed,
            contentPadding = padding,//sportDetailContentPadding,
            modifier = modifier//sportDetailModifier
                .weight(3f)
        )
    }
}
    ...
    SportsTheme {
        Surface {
            SportsListAndDetails(
                ...
                onBackPressed = {},
                /*sportDetailContentPadding*/ padding = PaddingValues(0.dp)
            )
        }
    }
}